      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><strong><font color="#00FF00"><?php echo $_SESSION['s_name'];?></font></strong></li>
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light"> Q Racing shop</h1>
        <p class="lead text-body-secondary">ชิ้นส่วนยานยนต์คุณภาพสูง</p>
        <p>
